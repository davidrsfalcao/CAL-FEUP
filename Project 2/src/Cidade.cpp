...
std::vector<std::string> Cidade::getPontosInteresse(){
	return pontos_iteresse;
}

void Cidade::setPontosInteresse(std::vector<std::string> pontos){
	this->pontos_iteresse = pontos;
}
