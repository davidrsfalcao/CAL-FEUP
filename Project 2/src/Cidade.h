...
private:
	...
	std::vector<std::string> pontos_iteresse;
...
public:
	...
	*/
	bool operator!=(const Cidade &ci);
	/**
	* @brief Função que retorna os pontos de interesse da cidade
	*
	* @return nome do ponto de interesse
	*/
	std::vector<std::string> getPontosInteresse();

	/**
	* @brief Função que define os pontos de interesse
	*
	* @param pontos vetor com os nomes dos pontos de interesse
	*/
	void setPontosInteresse(std::vector<std::string> pontos);
};
